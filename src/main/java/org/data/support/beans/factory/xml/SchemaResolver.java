 ...
 *
 * The format of <code>META-INF/query.schemas</code> is a properties
...
public class SchemaResolver implements EntityResolver {
	 ...
	 */
	public static final String DEFAULT_SCHEMA_MAPPINGS_LOCATION = "META-INF/query.schemas";
	 ...
	 * @see PropertiesLoaderUtils#loadAllProperties(String, ClassLoader)
	 */
	public SchemaResolver(ClassLoader classLoader, String schemaMappingsLocation) {
